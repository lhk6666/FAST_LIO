...
class ImuProcess
{
 public:
  ...
  void OnlyPredict(sensor_msgs::Imu::ConstSharedPtr imu, sensor_msgs::Imu::ConstSharedPtr prev_imu, esekfom::esekf<state_ikfom, 12, input_ikfom> &kf_state);
...
void ImuProcess::OnlyPredict(sensor_msgs::Imu::ConstSharedPtr imu, sensor_msgs::Imu::ConstSharedPtr prev_imu, esekfom::esekf<state_ikfom, 12, input_ikfom> &kf_state)
{
